...
<!-- Záznam práce, ne popis současnosti: čísla v reportech platila v den zápisu. -->
...
Schéma zdroje, číselníky a pravidla klasifikace přístupu stojí zvlášť
v [`DATA-MODEL.md`](DATA-MODEL.md) — jsou závazná i pro zdroje, které
s rozšířením na EU nemají nic společného, a nepatří proto do plánu jedné práce.
